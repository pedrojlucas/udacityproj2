...
# Total:        114  160  28.0    172     199#
 ...
 ab -n 10 -v 4 -p data.json -T 'application/json' -H 'Authorization: Bearer Fm437Ca4cmgKHX3l05FDi9r192s91n26' http://b46a4429-ae08-411f-ae50-9bf46c41a03c.southcentralus.azurecontainer.io/score
read -p "Please push a button to continue..."